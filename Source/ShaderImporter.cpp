...
bool ShaderImporter::CreateShaderObject(std::string& file, ShaderTypes shaderType) const
{
	bool ret = false;
	...
	{
		CONSOLE_LOG(LogTypes::Normal, "SHADER IMPORTER: Successfully created Shader Object '%s'", file.data());
		ret = true;
	}
